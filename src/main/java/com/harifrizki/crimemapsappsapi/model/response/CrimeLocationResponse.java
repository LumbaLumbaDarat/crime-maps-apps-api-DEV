...
public class CrimeLocationResponse {
    ...
    @Getter @Setter
    private List<CrimeLocationModel> crimeLocations = new ArrayList<>();
    ...
    public CrimeLocationResponse() {
    }

    public String toJson(CrimeLocationResponse response, int operation) {
